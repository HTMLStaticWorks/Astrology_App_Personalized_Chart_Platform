    ...
    footerRoot.innerHTML = `
      <footer class="bg-slate-950 border-t border-indigo-950/30 text-slate-400 py-16 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <!-- Column 1: Brand -->
          <div class="space-y-4">
            <div class="flex items-center space-x-2 rtl:space-x-reverse text-[#cf9b44] font-bold text-lg tracking-wider">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="transform: rotate(-15deg);">
                <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
              </svg>
              <span data-t-logo class="font-serif text-slate-100 tracking-[0.2em]">${t.logo}</span>
            </div>
